...
- `https://hackathon-finals.vercel.app/` is a polished landing page in Uzbek. Its primary `Boshlash` links currently point to `https://app-Aqurin.vercel.app` rather than the deployed main site.
